...
# ADNO: modified to output full potential too
...
#                             )
    ...
    def print_output_results(self, Potential_at_1,
        ...
        print('Potential = ' + str(Potential_FULL)+"\n")
    ...
    def write_output_results(self, Potential_at_1,
        ...
        out_file.write('Potential = ' + str(Potential_FULL)+'\n\n')
...
def main():
    ...
    *_, Potential_FULL=evaluator.computePrecisionMetrics_at_K(None)
    ...
    Potential_FULL_floored=math.floor(Potential_FULL * factor) / factor
